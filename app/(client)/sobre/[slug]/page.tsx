                ...
                <div>
                  ...
                  <div className="mt-10">
                    <Link href="/sobre" className="flex items-center gap-1">
                      ...
                      <span className="text-sm font-semibold">Voltar para Sobre</span>
                    </Link>
                  </div>
                </div>
              </div>
  ...
  return (
    <div>
      ...
      <div className="border border-lightColor p-5 rounded-md mt-10">
        <Title className="text-base">Últimos Posts</Title>
            ...
            >
              {blog?.mainImage && (
                <Image
                  ...
                  width={100}
                  height={100}
                  className="w-16 h-16 rounded-full object-cover border border-[#82181a]/10 group-hover:border-[#82181a] hoverEffect"
                />
              )}
              <p className="line-clamp-2 text-sm text-lightColor group-hover:text-[#82181a] hoverEffect">
                {blog?.title}
              </p>
            </Link>
          ))}
...
export default SingleSobrePage;
